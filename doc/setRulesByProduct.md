...
##Request Data
 ...
 singleAmount| |Boundery amount of a single transacction selected by the customer 
 totalAmount| |Boundery of accumulative amount on transacctions selecter by the customer 
 varation| | 
